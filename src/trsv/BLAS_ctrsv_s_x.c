 ...
 */
{
  ...
  float		  T_element;	/* temporary variable for an element of
				 * matrix A */
      ...
      {
	{
	  ...
	  if ((order == blas_rowmajor &&
...

		{
		  ...
		  {
		    /*
		     * Compute double-double = double-double / double, using
		     * a Newton iteration scheme.
		     */
		    double	    b1  , b2, con, e, t1, t2, t11, t21, t12,
		    		    t22;
