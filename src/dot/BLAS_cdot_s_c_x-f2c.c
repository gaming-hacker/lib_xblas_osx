...
extern void	FC_FUNC_(blas_cdot_s_c_x, BLAS_CDOT_S_C_X)
                (int *conj, int *n, const void *alpha, const float *x, int *incx, const void *beta, const void *y, int *incy, void *r, int *prec)
{
  BLAS_cdot_s_c_x((enum blas_conj_type)*conj, *n, alpha,
		  x, *incx, beta,
		  y, *incy,
