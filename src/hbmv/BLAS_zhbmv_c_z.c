 ...
 */
{
  ...
  if (alpha_i[0] == 0.0 && alpha_i[1] == 0.0) {
    ...
    /*
     * maj_first is number of elements done in first loop (this will increase
     * by one over each column up to a limit)
     */
    maxj_first = 0;

    /*
     * maxj_second is number of elements done in second loop the first time
     */
